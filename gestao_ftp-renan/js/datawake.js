...
function formDefault() {
  ...
  estrutura +=
    ' <div class="col">   <button type="button" class="btn btn-outline-dark" id="addNew" disabled>Adicionar novo</button>';
  estrutura +=
...
function getFormData(form, evento) {
  ...
  var camposString = "observacao / geralEmbalagemTipo / responsavel / cliente / unidade_Negocio / tipo_Projeto / tipo_Evento / status_Projeto / tamanho / fechamento / pino / tierline / customer / business / level_current / mes / analista_Responsavel/ planta_do_Cliente / reclamacao_oficial / reincidencia / contratacao_Empresaterceira / procede / gp12 / classificacao_Reclamacao / solicitacao_Cs1_U_Cs2 / itens_Seguranca";
...
function fInitTbl(thedata, tipTable) {
  ...
  switch (tipTable) {
    ...
    case "FORMPPAP":
      ...
      $("#tabLista thead tr").append("<th>PLANTA</th>");
      $("#tabLista thead tr").append("<th>CÉLULA</th>");
  ...
  if (idSelec != "" && idSelec != undefined) {
    ...
    document.getElementById("addNew").className = "btn btn-success";
  ...
  table.on("deselect", function (e, dt, type, indexes) {
    ...
    document.getElementById("addNew").className = "btn btn-outline-dark";
  });
...
function formGembaWalk6() {
  $nameTitleForm = "GEMBA WALK 6";
  path = "/v1/ftpgembawalk6";
  thedata = fRetRegs(null, 0);
  $nameForm1 = "#formGembaWalk6";
  $nameForm2 = "";
  $idColumn = "id";
  ...
  if (typeof thedata != "boolean") {
    thedata =
      thedata["totalElements"] > thedata["size"]
        ...
        : thedata;
    if (typeof thedata != "boolean") {
      fInitTbl(thedata.content, "FORMGEMBAWALK6");
    }
    loadPage(getHost() + "/formGembaWalk6.html", "", "formQuest");
  }
}
